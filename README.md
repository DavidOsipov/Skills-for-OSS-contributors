...
| Skill                                                | Purpose                                                                                                                                                                       |
| ---------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [XMP Image Metadata](./skills/xmp-image-metadata-portable/) | Inspect images, prepare verified metadata, reverse-geocode coordinates with privacy controls, and embed standards-compatible XMP, IPTC, EXIF, Dublin Core, and PLUS metadata. |

### Portable XMP Image Metadata

The [`xmp-image-metadata`](./skills/xmp-image-metadata-portable/) skill is designed for careful metadata work across JPEG, PNG, WebP, AVIF, HEIC, TIFF, and other ExifTool-writable formats.
...
See [`xmp-image-metadata/SKILL.md`](./skills/xmp-image-metadata-portable/SKILL.md) for the complete workflow, safety rules, dependencies, and commands.
